...
<div className="bg-white border border-zinc-200 rounded-2xl md:rounded-3xl shadow-sm overflow-hidden grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 divide-x divide-y sm:divide-y-0 divide-zinc-100">
  {[
    ...
    >
      ...
      <h3 className="text-xl md:text-3xl font-bold text-zinc-900 tracking-tight leading-none mt-2 md:mt-3 md:self-center">
        {stat.value}
      </h3>
      ...
      <div className="flex items-center gap-2 mt-2 md:mt-3 md:self-center">
        ...
        <span className="hidden md:block text-2xs font-bold text-zinc-300 uppercase tracking-wide xl:tracking-widest">
          vs período ant.
        </span>
      </div>
    </motion.div>
